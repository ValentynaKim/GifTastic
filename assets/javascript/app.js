var animals = ['Elephant', 'Cat', 'Snake'];


	function displayGif(){

		var gif = $(this).attr('data-name');
		var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=30JspaJIb3w1ZakLhJQZgtog3Z26m3mp&q=" + gif + "&limit=10&offset=0&lang=en";
	...
	function renderButtons(){ 
		...
		for (var i = 0; i < animals.length; i++){
		    ...
		    var newButton = $('<button class="btn btnA">') 
